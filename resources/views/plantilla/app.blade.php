...
<head>
    ...
    <meta name="keywords" content="Sistema, FullStack, Boostrap, PHP, Laravel, JavaScript, MySQL">
...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
        ...
        <footer class="app-footer">
            <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">Laravel 12 - FullStack</div>
            <!--end::To the end-->
            <!--begin::Copyright--> <strong>
                Copyright &copy;2025&nbsp;
                <a href="#" class="text-decoration-none">douglasrujana.dev</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer>
